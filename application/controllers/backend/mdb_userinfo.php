...
class Mdb_userinfo extends Controller {
	...
	function index()
	{
		...
		$this->db2 = $CI->load->database('db_access', TRUE);
		$qry = $this->db2->query("SELECT * FROM tb_userinfo");
		/*
		...
		*/
		...
		$data['template'] = 'm_jemaat/index_access';
