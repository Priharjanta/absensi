				...
				<form action="" role="form" method="post" enctype="multipart/form-data">
					<div class="col-lg-6">
						...
						<div class="form-group input-group">
							...
							<input type="text" name="m_keg_name" class="form-control" value="<?php echo $row->m_keg_name; ?>">
						</div>
						...
						<div class="form-group input-group">
							...
							<?php $time_s = explode(':',$row->m_keg_start_time);?>
						...
						<div class="form-group input-group">
							...
							<?php $time_e = explode(':',$row->m_keg_end_time);?>
						...
						<div class="form-group input-group">
							...
							<input type="text" name="m_keg_lokasi" class="form-control" value="<?php echo $row->m_keg_lokasi; ?>">
						</div>
						<div class="form-group input-group">
							<span class="input-group-addon">Keterangan</span>
							<textarea id="m_keg_ket" name="m_keg_ket" class="form-control" ><?php echo $row->m_keg_ket; ?></textarea>
						</div>
						<?php echo form_error('m_keg_aktif', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<div class="form-group input-group">
							<span class="input-group-addon">Aktif</span>	
							<?php echo yesnoDropdown(FALSE,'m_keg_aktif',$row->m_keg_aktif);?>
						</div>
						</div>
						<p>
