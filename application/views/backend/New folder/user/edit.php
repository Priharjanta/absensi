...
<h1>User <?php echo $row->user_login;?></h1>
    ...
    <fieldset>
		...
		<ul>
			<li>
				...
				<input type="text" name="user_login" class="text span-12" value="<?php echo $row->user_login;?>">
			</li>
			<li>
			...
			<li>
				...
				<input type="text" name="user_display_name" class="text  span-12" value="<?php echo $row->user_display_name;?>">
			</li>
			<li>
				<label for="user_email">Email</label>
				<?php echo form_error('user_email', '<div class="error">', '</div>'); ?>
				<input type="text" name="user_email" class="text  span-12" value="<?php echo $row->user_email;?>">
			</li>
			<li>
				<label for="user_rule">User Rule</label>
				<?php echo form_error('user_rule', '<div class="error">', '</div>'); ?>
				<?php echo ruleDropdown($row->user_rule);?>
