...
<table style="width:50%">
	...
	<tr>
		<td><strong>All Datawarehouse DB</strong></br></td>
		<td>
		<a class="btn" href="<?php echo site_url('backend/ekstrak/load_all')?>">Load</a> | 
		<a class="btn" href="<?php echo site_url('backend/ekstrak/clean_all')?>">Clean</a>
		</td>
	</tr>
</table>
