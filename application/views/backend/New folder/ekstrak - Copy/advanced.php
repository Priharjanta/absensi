...
<table style="width:50%">
	...
	<tr>
		...
		<td>
		<a class="btn" href="<?php echo site_url('backend/ekstrak/load/time')?>">Load</a> | 
		<a class="btn" href="<?php echo site_url('backend/ekstrak/clean/time')?>">Clean</a>
		</td>
	</tr>
	<tr>
		<td><strong>Sales Fact</strong></td>
		<td>
		<a class="btn" href="<?php echo site_url('backend/ekstrak/load/sales')?>">Load</a> | 
