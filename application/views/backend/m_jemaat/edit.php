				...
				<form action="" role="form" method="post" enctype="multipart/form-data">
					<div class="col-lg-6">
						...
						<div class="form-group input-group">
							...
							<input type="text" name="m_jmt_no_induk" class="form-control" value=<?php echo $row->m_jmt_no_induk; ?>>
						</div>
						<?php echo form_error('m_jmt_finger_id', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Finnger ID</span>
							<input type="text" name="m_jmt_finger_id" class="form-control" value=<?php echo $row->m_jmt_finger_id; ?>>
						</div>
						<?php echo form_error('m_jmt_nama', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Nama Jemaat *</span>
							<input type="text" name="m_jmt_nama" class="form-control" value="<?php echo $row->m_jmt_nama; ?>">
						</div>
						<?php echo form_error('m_jmt_jenkel', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Jenis Kelamin *</span>
							<?php echo jenkelDropdown($row->m_jmt_jenkel);?>
						</div>
						<?php echo form_error('m_jmt_tgl_lhr', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Tanggal Lahir *</span>
							<?php echo dateDropdown('m_jmt_tgl_lhr',$row->m_jmt_tgl_lhr,'1950','2020');?>
						</div>
						<?php echo form_error('m_jmt_tmpt_lhr', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Tempat Lahir *</span>			
							<input type="text" name="m_jmt_tmpt_lhr" class="form-control" value="<?php echo $row->m_jmt_tmpt_lhr; ?>">
						</div>
						...
						<div class="form-group input-group">
							...
							<div id="txtHintKotkec_1">
								<?php echo kotkecDropDown($row->m_jmt_prov_id_1,$row->m_jmt_kab_id_1,$row->m_jmt_kec_id_1,'m_jmt_kec_id_1'); ?>
							</div>
						</div>
						<?php echo form_error('m_jmt_telp_1', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Telp / HP*</span>
							<input type="text" name="m_jmt_telp_1" class="form-control" value="<?php echo $row->m_jmt_telp_1; ?>">
						</div>
						<?php echo form_error('m_jmt_alamat_2', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Alamat 2</span>
							<input type="text" name="m_jmt_alamat_2" class="form-control" value="<?php echo $row->m_jmt_alamat_2; ?>">
						</div>
						<?php echo form_error('m_jmt_prov_id_2', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Province</span>
							<?php echo provDropdown($row->m_jmt_prov_id_2,'m_jmt_prov_id_2','showKab_2')?>
						</div>
						<?php echo form_error('m_jmt_kab_id_2', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Kabupaten</span>
							<div id="txtHintKab_2">
								<?php echo kabDropdown($row->m_jmt_prov_id_2,$row->m_jmt_kab_id_2,'m_jmt_kab_id_2','showKotkec_2')?>
							</div>
						</div>
						...
						<div class="form-group input-group">
							...
							<div id="txtHintKotkec_2">
								<?php echo kotkecDropDown($row->m_jmt_prov_id_2,$row->m_jmt_kab_id_2,$row->m_jmt_kec_id_2,'m_jmt_kec_id_2'); ?>
							</div>
						</div>
						<?php echo form_error('m_jmt_telp_2', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Telp / HP</span>
							<input type="text" name="m_jmt_telp_2" class="form-control" value="<?php echo $row->m_jmt_telp_2; ?>">
						</div>
					</div>
					<div class="col-lg-6">
						...
						<div class="form-group input-group">
							...
							<?php echo yesnoDropdown(FALSE,'m_jmt_anggota',$row->m_jmt_anggota);?>
						</div>
						<?php echo form_error('m_jmt_wil_id', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Wilayah</span>	
							<?php echo wilayahDropdown($row->m_jmt_wil_id,'m_jmt_wil_id',FALSE);?>
						</div>
						<?php echo form_error('m_jmt_baptis', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Status Baptis</span>	
							<?php echo yesnoDropdown('notyet','m_jmt_baptis',$row->m_jmt_baptis);?>
						</div>
						...
						<div class="form-group input-group">
							...
							<input type="text" name="m_jmt_grj_baptis" class="form-control" value="<?php echo $row->m_jmt_grj_baptis; ?>">
						</div>
						<?php echo form_error('m_jmt_tgl_baptis', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Tanggal Baptis</span>
							<?php echo dateDropdown('m_jmt_tgl_baptis',$row->m_jmt_tgl_baptis,'1950','2020');?>
						</div>
						...
						<div class="form-group input-group">
							...
							<?php echo dateDropdown('m_jmt_tgl_masuk',$row->m_jmt_tgl_masuk,'1950','2020');?>
						</div>
						<?php echo form_error('m_jmt_aktif', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Aktif</span>
							<?php echo yesnoDropdown(FALSE,'m_jmt_aktif',$row->m_jmt_aktif);?>
						</div>
						<?php echo form_error('m_jmt_ket', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Keterangan</span>
							<input type="text" name="m_jmt_ket" class="form-control" value="<?php echo $row->m_jmt_ket; ?>">
						</div>
						<?php echo form_error('m_jmt_parent_child_id', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Keluarga</span>
							<input type="text" name="m_jmt_parent_child_id" class="form-control" value="<?php echo $row->m_jmt_parent_child_id; ?>">
						</div>
						<?php echo form_error('m_jmt_parent_child_hub', '<div class="alert alert-danger">', '</div>'); ?>
							...
							<input type="text" name="m_jmt_parent_child_hub" class="form-control" value="<?php echo $row->m_jmt_parent_child_hub; ?>">
						</div>
						<p>
							* Harus diisi
						</p>
