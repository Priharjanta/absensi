				...
				<form action="" role="form" method="post" enctype="multipart/form-data">
					<div class="col-lg-6">
						...
						<div class="form-group input-group">
							...
							<input type="text" style="text-transform: uppercase" id="jmt_id" autocomplete="off" autocomplete="false" onkeyup="autocompletJmt()" value="<?php echo $jmt_nama;?>" class="form-control" placeholder="Ketik nama ...">
							<input type="hidden" id="jmt_id_id" name="pkj_m_jmt_id" class="form-control"  value="<?php echo $pkj_m_jmt_id;?>">
