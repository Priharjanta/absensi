				...
				<form action="" role="form" method="post" enctype="multipart/form-data">
					<div class="col-lg-6">
						...
						<div class="form-group input-group">
							...
							<input type="text" name="m_ib_name" class="form-control" value="<?php echo set_value('m_ib_name'); ?>">
						</div>
						...
						<div class="form-group input-group">
							...
							<?php 
								if(set_value('m_ib_start_time')):
									$time_s = explode(':',set_value('m_ib_start_time'));
								else:
						...
						<div class="form-group input-group">
							...
							<?php 
								if(set_value('m_ib_end_time')):
									$time_e = explode(':',set_value('m_ib_end_time'));
								else:
						...
						<div class="form-group input-group">
							...
							<input type="text" name="m_ib_lokasi" class="form-control" value="<?php echo set_value('m_ib_lokasi'); ?>">
						</div>
						<div class="form-group input-group">
							<span class="input-group-addon">Keterangan</span>
							<textarea id="m_ib_ket" name="m_ib_ket" class="form-control" ><?php echo set_value('m_ib_ket'); ?></textarea>
						</div>
						<?php echo form_error('m_ib_aktif', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<div class="form-group input-group">
							<span class="input-group-addon">Aktif</span>	
							<?php echo yesnoDropdown(FALSE,'m_ib_aktif',set_value('m_ib_aktif'));?>
						</div>
						</div>
						<p>
