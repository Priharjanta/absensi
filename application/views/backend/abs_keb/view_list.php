...
function absKeb(id)
{
	url = "<?php echo site_url().'backend/abs_keb/view/hdr/'?>"+id;
						...
						<div class="table-responsive table-bordered">
							<table class="table table-hover">
											...
											<div class="panel panel-default">
												...
												<div class="panel-body">
													<ul class="list-unstyled">
														...
														<li><strong>On Time : </strong></li><li><?php echo cekKehadiran(TRUE,'keb','late',$row["keb_id"],$row['keb_tgl'].' '.$row['m_ib_start_time'])?></li>
														<li><strong>Terlambat : </strong></li><li><strong class="text-danger"><?php echo cekKehadiran(TRUE,'keb','ontime',$row["keb_id"],$row['keb_tgl'].' '.$row['m_ib_start_time'])?></strong></li>
													</ul>
												</div>
												<div class="panel-footer">
													<button onClick="absKeb(<?php echo $row["keb_id"];?>)" type="button" class="btn btn-lg btn-primary btn-block"><strong>Absen Kehadiran</strong></button>
												</div>
											</div>
										<!-- /.modal-content -->
									</div>
								...
								<tr>
									...
									<div>
										<button onClick="absKeb(<?php echo $row["keb_id"];?>)" type="button" class="btn btn-primary btn-xs">Absen Kehadiran</button>
										<button onClick="GuestPage(<?php echo $row["keb_id"];?>)" type="button" class="btn btn-primary btn-xs">Guest Page</button>
										<button data-toggle="modal" data-target="#myModalInfoKeb-<?php echo $row["keb_id"];?>" type="button" class="btn btn-info btn-xs">Lihat Detil</button>
