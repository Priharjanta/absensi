...
function CariPertahun()
{
	var key_nama 	= document.getElementById("key_nama").value;
	var form 		= document.getElementById("cari_pertahun");
...
function BackPertahun()
{
	url = "<?php echo site_url().'backend/rep_jemaat/pertahun'?>";
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
                ...
                <div class="tab-content">
					<div class="tab-pane fade in active" id="pertahun">
						<h4><?php echo $title;?></h4>
						<div class="row">
						<form id="<?php echo $form_id;?>" action="<?php echo site_url();?>backend/rep_jemaat/pertahun" method="POST">
							<div class="col-lg-3">
							...
							<div class="col-lg-3">
								...
								<span class="input-group-addon">Tahun</span>
									<?php echo tahunDropdown('filter_thn',$date_time,$this->config->item('y_begin'),$this->config->item('y_end'))?>
								</div>
							</div>
