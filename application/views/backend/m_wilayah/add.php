				...
				<form action="" role="form" method="post" enctype="multipart/form-data">
					<div class="col-lg-6">
						...
						<div class="form-group input-group">
							...
							<input type="text" name="m_wil_name" class="form-control" value="<?php echo set_value('m_wil_name'); ?>">
						</div>
						...
						<div class="form-group input-group">
							...
							<input type="text" name="m_wil_koord_name" class="form-control" value="<?php echo set_value('m_wil_koord_name'); ?>">
						</div>
						<?php echo form_error('m_wil_phone', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Telepon / HP</span>
							<input id="m_wil_phone" name="m_wil_phone" class="form-control"  value="<?php echo set_value('m_wil_phone'); ?>">
						</div>
						<?php echo form_error('m_wil_koord_jmt_id', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">ID Jemaat</span>	
							<input type="text" name="m_wil_koord_jmt_id" class="form-control" value="<?php echo set_value('m_wil_koord_jmt_id'); ?>">
						</div>
						<?php echo form_error('m_wil_area', '<div class="alert alert-danger">', '</div>'); ?>
						<div class="form-group input-group">
							<span class="input-group-addon">Area / Wilayah</span>
							<textarea id="m_wil_area" name="m_wil_area" class="form-control" ><?php echo set_value('m_wil_area'); ?></textarea>
						</div>
						<p>
