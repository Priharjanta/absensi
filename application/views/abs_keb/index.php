						...
						<div class="table-responsive table-bordered">
							<table class="table table-hover">
								...
								<tr>
									<td><?php echo $no;?></td>
									<td>
									<b><?php echo getDataTableById('tb_m_ibadah','m_ib_name','m_ib_id',$row['keb_m_ib_id'])?></b>
									<div>
										...
										<button onClick="GuestPage(<?php echo $row["keb_id"];?>)" type="button" class="btn btn-success btn-xs">Guest Page</button>
									</div>
									</td>
									<td><?php echo indDate($row["keb_tgl"]);?></td>
